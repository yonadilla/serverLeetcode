...
//Changes Required
const codeforeces_URL_1='https://codeforces.com/api/user.rating?handle=yonadilla';
const codeforeces_URL_2='https://codeforces.com/api/user.info?handles=yonadilla';
try{
